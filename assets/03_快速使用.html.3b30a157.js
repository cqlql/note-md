import{_ as s}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as n,a,b as e}from"./app.c8c605f7.js";const p={},l=e(`<p>\u5982\u679C\u662F docker \uFF0C\u5219\u5148\u8981\u8FDB\u5165 mysql \u5BB9\u5668\u73AF\u5883</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>
...
<span class="token comment"># \u63A5\u4E0B\u6765\u8F93\u5165\u5BC6\u7801</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>\u521B\u5EFA\u7528\u6237\uFF0C\u6570\u636E\u5E93\u8868\uFF0C\u6743\u9650</p><div class="language-sql ext-sql line-numbers-mode"><pre class="language-sql"><code><span class="token keyword">create</span> <span class="token keyword">user</span> <span class="token string">&#39;joly&#39;</span><span class="token variable">@&#39;%&#39;</span> identified <span class="token keyword">by</span> <span class="token string">&quot;\u65B0\u5BC6\u7801&quot;</span><span class="token punctuation">;</span>
